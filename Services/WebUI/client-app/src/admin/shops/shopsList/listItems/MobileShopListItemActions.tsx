...
import {
    AddLocationAlt,
    Delete, DriveEtaOutlined, GarageOutlined,
...
import {MobileShopVehicleUpdate} from "../modals/mobileShop/MobileShopVehicleUpdate";
...
function MobileShopListItemActions({shop}: Props) {
    ...
    const handleVehicleUpdate = (newVehiclePlateNumber: string) => {
        adminShopStore.setShopToUpdateId(shop.id)
        adminShopStore.setMobileShopUpdateValues(newVehiclePlateNumber,null, null, null, null, null)
    ...
    const handleSalePointAdd = (newSalePoint: SalePoint) => {
        adminShopStore.setShopToUpdateId(shop.id)
        adminShopStore.setMobileShopUpdateValues(null, newSalePoint, null, null, null, null)
        modalStore.closeModal()
        adminShopStore.updateShop()
    }
    ...
    const handleSalePointDelete = (salePointToDelete: SalePoint) => {
        adminShopStore.setShopToUpdateId(shop.id)
        adminShopStore.setMobileShopUpdateValues(null, null, salePointToDelete, null, null, null)
        modalStore.closeModal()
        adminShopStore.updateShop()
    }
    ...
    const handleSalePointDisable = (salePointToDisable: SalePoint) => {
        adminShopStore.setShopToUpdateId(shop.id)
        adminShopStore.setMobileShopUpdateValues(null, null, null, salePointToDisable, null, null)
        modalStore.closeModal()
        adminShopStore.updateShop()
    }
    ...
    const handleSalePointEnable = (salePointToEnable: SalePoint) => {
        adminShopStore.setShopToUpdateId(shop.id)
        adminShopStore.setMobileShopUpdateValues(null, null, null, null, salePointToEnable, null)
        modalStore.closeModal()
        adminShopStore.updateShop()
    }
    ...
    function handleSalePointUpdate(updatedSalePoint: SalePoint) {
        adminShopStore.setShopToUpdateId(shop.id)
        adminShopStore.setMobileShopUpdateValues(null, null, null, null, null, updatedSalePoint)
        modalStore.closeModal()
        adminShopStore.updateShop()
    }
    ...
    return (
        <>
            <IconButton style={{borderRadius: '0px', color: '#777777', flexDirection:'column', width: '11.5%'}} size='medium'
                        onClick={() => modalStore.openModal(
                            <MobileShopVehicleUpdate vehiclePlateNumber={shop.vehiclePlateNumber}
                                                     onSubmit={(newVehiclePlateNumber) => handleVehicleUpdate(newVehiclePlateNumber)}/>)}>
                <DriveEtaOutlined />
                <Typography variant='caption'>Zmień numer rejestracyjny</Typography>
            </IconButton>
            <IconButton style={{borderRadius: '0px', color: '#042cab', flexDirection:'column', width: '11.5%'}} size='medium'
                        onClick={() => modalStore.openModal(
            ...
            <IconButton style={{borderRadius: '0px', color: '#b50000', flexDirection:'column', width: '11.5%'}} size='medium'
                        disabled={shop.salePoints.length < 1} onClick={() => modalStore.openModal(
            ...
            <IconButton style={{borderRadius: '0px', color: '#00949b', flexDirection:'column', width: '11.5%'}} size='medium'
                        disabled={shop.salePoints.filter(sp => sp.isClosed).length < 1}
                        onClick={() => modalStore.openModal(
